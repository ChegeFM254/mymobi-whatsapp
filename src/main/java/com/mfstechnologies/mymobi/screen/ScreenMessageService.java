...
public class ScreenMessageService {
     ...
     */
    public void sendOptIn(String to) {
        Map<String, Object> payload = Map.of(
                "messaging_product", "whatsapp",
                "to", to,
                "type", "interactive",
    ...
    public void sendTerms(String to) {
        Map<String, Object> payload = Map.of(
                "messaging_product", "whatsapp",
                "to", to,
                "type", "interactive",
     ...
     */
    public void sendConfirmation(String to, com.mfstechnologies.mymobi.model.UserSession session) {
    ...
    public void sendEditOptions(String to) {
        Map<String, Object> payload = Map.of(
                "messaging_product", "whatsapp",
                "to", to,
                "type", "interactive",
     ...
     */
    public void sendLoanTenureOptions(String to) {
        Map<String, Object> payload = Map.of(
                "messaging_product", "whatsapp",
                "to", to,
                "type", "interactive",
    ...
    public void sendLoanAmountMenu(String to, int loanLimit, int tenureMonths) {
    ...
    public void sendApproveLoanDetails(String to, com.mfstechnologies.mymobi.model.Loan loan) {
     ...
     */
    public void sendCancelLoanConfirm(String to) {
        Map<String, Object> payload = Map.of(
                "messaging_product", "whatsapp",
                "to", to,
                "type", "interactive",
    ...
    public void sendPayLoanOptions(String to, int remainingInstallments, int monthlyInstallmentAmount) {
     ...
     * version.
     */
    public void sendPayLoanConfirm(String to, int installments, int totalAmount, int remainingBalanceAfter, int remainingInstallmentsAfter) {
    ...
    public void sendPayslipConfirm(String to, int months, double cost) {
     ...
     * loan status is "paid".
     */
    public void sendLoanClearanceConfirm(String to, double cost) {
